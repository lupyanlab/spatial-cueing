---
title: "Spatial Cueing Experiments"
author: "Pierce Edmiston"
date: "April 17, 2015"
output: html_document
---

```{r, get-spatial-cueing-data, message = FALSE, warning = FALSE}
source("R/loaders.R")
cueing <- get_spatial_cueing(interval = c(0.750, 0.100), flicker = c("on", "off"))
```
...
between_subj_conditions <- expand.grid(
  ...
  ) %>% filter(!(flicker == "off" & interval == 0.10))  # don't get preds for missing exp
...
```{r, cueing-effects-in-accuracies, message = FALSE}
library(ggplot2)
library(scales)
source("R/plots.R")
...
```{r, cueing-effect-in-rts, message = FALSE}
